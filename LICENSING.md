...
A `LICENSE-haystack` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [deepset-ai/haystack](https://github.com/deepset-ai/haystack), Copyright
2021 deepset GmbH, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../haystack-port/specs/SPEC-001-haystack.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
